...
class ParserModel(nn.Module):
    ...
    def __init__(self, embeddings, n_features=36,
        ...
        # Initialize weights and biases for embedding to hidden layer
        ...
        # Initialize weights and biases for hidden to logits layer
    ...
    def embedding_lookup(self, w):
        ...
        embeddings = embeddings.view(-1, self.n_features * self.embed_size)
        return embeddings
